...
@interface FtpUserSettingVC ()

@end

@implementation FtpUserSettingVC
...
{
    [[NSUserDefaults standardUserDefaults] setObject:textField.text forKey:kUSER_DEFAULT_FTPUSER];
    [[NSUserDefaults standardUserDefaults] synchronize];
}

- (NSString*)value{
    return [[NSUserDefaults standardUserDefaults] objectForKey:kUSER_DEFAULT_FTPUSER];
}
