...
@interface GyroSettingVC ()

@end

@implementation GyroSettingVC
...
{
    [[NSUserDefaults standardUserDefaults] setObject:textField.text forKey:kUSER_DEFAULT_GYROVALUE];
...
- (NSString*)value
{
    return [[NSUserDefaults standardUserDefaults] objectForKey:kUSER_DEFAULT_GYROVALUE];
}
